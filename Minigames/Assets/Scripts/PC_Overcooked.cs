...
public class PC_Overcooked : PlayerController {
    ...
    public void PickUpObj() {
        if (inRange && pickedUpObj.GetComponent<ItemController>().lastPlayerObj == null || pickedUpObj.GetComponent<ItemController>().lastPlayerObj == this.gameObject && pickUpC != 0 && inRange && objCarry == false && pickedUpObj.GetComponent<ItemController>().filling == false) {
            objCarry = true;
