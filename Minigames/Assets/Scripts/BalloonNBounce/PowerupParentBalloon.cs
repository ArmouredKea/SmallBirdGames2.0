...
public class PowerupParentBalloon : MonoBehaviour
{//This is actually a Manager not a parent'
    ...
    public virtual IEnumerator PowerupTimerR(float seconds, PC_BalloonNBounce player, Color color)
    {
        powerupProg = player.transform.Find("PowerupTimeZone").GetComponentInChildren<Canvas>().transform.Find("ProjTimerRunner").GetComponentInChildren<Image>();
    ...
    public virtual IEnumerator PowerupTimerG(float seconds, PC_BalloonNBounce player, Color color)
    {
