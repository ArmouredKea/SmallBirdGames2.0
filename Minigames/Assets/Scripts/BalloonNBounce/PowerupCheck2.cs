...
public class PowerupCheck2 : MonoBehaviour
{
 
    public GunnerPowerupsBalloon gunnerSpawn;
    public RunnerPowerupsBalloon runnerSpawn;
    ...
    public PC_BalloonNBounce getRunner;
    public PC_BalloonNBounce gunner;
    ...
    {   
        if(forShooter == true)
        {
            if (collision.tag == "Projectile")
            {
                ...
                if (gunnerSpawn.Powerup_Activated == false)
                {
                    if (collision != null)
                    {
                        gunner = collision.gameObject.GetComponent<ProjectileParent>().firedFrom.GetComponent<PC_BalloonNBounce>();
                    }
        ...
        else if (forRunner == true)
        {
            ...
            {
                //"Pop" effect here.
                getRunner = collision.gameObject.GetComponent<PC_BalloonNBounce>();
