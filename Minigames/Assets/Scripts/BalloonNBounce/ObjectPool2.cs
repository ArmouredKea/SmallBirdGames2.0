...
{
    public static ObjectPool2 pool_Instance2;
    public static ObjectPool2 pool_Instance1;//If others want to use this, can help.
    // Start is called before the first frame update
   // public List<GameObject> pool_List; // List of pooled objects

    public GameObject pool_ObjectP1;
    public GameObject pool_ObjectP2;// Object to pool
    ...
    public bool pool_YellowProjTime2;
    public bool pool_GreenProjTime2;
    public bool pool_WhiteProjTime2;
    public bool pool_BlueProjTime2;
   ...
   // public List<GameObject> pool_ListR;
        ...
        for (int i = 0; i < pool_NumToPool; i++)
        {
          ...
          //  GameObject pool_objRed = (GameObject)Instantiate(pool_RedProj);
           ...
           // GameObject pool_objYellowChild = (GameObject)Instantiate(pool_YellowChildProj);
            ...
            pool_ObjectP1.SetActive(false);
            pool_ObjectP2.SetActive(false);
    ...
    public void StopAll()
    {
            ...
            ObjectPool2.pool_Instance2.pool_YellowProjTime = false;
            ObjectPool2.pool_Instance2.pool_GreenProjTime = false;
            ObjectPool2.pool_Instance2.pool_WhiteProjTime = false;
